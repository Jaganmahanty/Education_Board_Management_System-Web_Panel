...
class VerifiedStudentData extends StatefulWidget {
  const VerifiedStudentData({super.key});

  @override
  State<VerifiedStudentData> createState() => _VerifiedStudentDataState();
}

class _VerifiedStudentDataState extends State<VerifiedStudentData> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const verifiedStudentDataWidget(),
    );
  }
}

// ignore: camel_case_types
class verifiedStudentDataWidget extends StatefulWidget {
  const verifiedStudentDataWidget({super.key});

  @override
  State<verifiedStudentDataWidget> createState() =>
      _verifiedStudentDataWidgetState();
}

// ignore: camel_case_types
class _verifiedStudentDataWidgetState extends State<verifiedStudentDataWidget> {
